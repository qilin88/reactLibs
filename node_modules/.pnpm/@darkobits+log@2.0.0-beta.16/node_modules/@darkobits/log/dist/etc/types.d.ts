...
import { IS_PREFIX } from "./constants";
 ...
 */
export declare type StyleFunction = (token: string, chalk: Chalk) => string;
/**
 ...
 */
export declare type LogFunction<T = void> = (...args: Array<any>) => T;
/**
 ...
 */
export declare type MessageFn = () => any;
/**
 ...
 */
export declare type EndInteractiveFn = (options?: MessageFn | EndInteractiveOptions) => void;
/**
